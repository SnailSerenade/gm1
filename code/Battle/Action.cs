...
{
	public Action( Entity actor ) => Actor = actor;

	public virtual string Name => GetType().Name;

	[Net] public Entity Actor { get; protected set; } = null;
	...
	public virtual bool CheckTarget( Entity target ) { return false; }

	public virtual void Perform( Entity target )
	{
...
{
	public Ability( Entity actor ) : base( actor ) { }

	public virtual float DamageBase => 1.0f;

	public override bool CheckTarget( Entity target )
	{
